...
+---------------+-------------+-------------+------------------------------------------------------------+
| 29-Sep        | 5           | Th          | Species Distribution Modeling with `sdmTMB` (Dr. Eric Ward, NOAA NWFSC)\                                   |
|               |             |             | *Homework 2 due (SES modeling)*                   |
+---------------+-------------+-------------+------------------------------------------------------------+
| 4-Oct         | 6           | T           | Multispecies models II                     |
+---------------+-------------+-------------+------------------------------------------------------------+
| 6-Oct         | 6           | Th          | Models of Intermediate Complexity for Ecosystems (MICE)\                                    |
...
+---------------+-------------+-------------+------------------------------------------------------------+
| 27-Oct        | 9           | Th          | Ecosystem MSEs (Rpath module, Dr. Sean Lucey, NOAA NEFSC)\                             |
|               |             |             | *Project plans due*                                        |
+---------------+-------------+-------------+------------------------------------------------------------+
| 1-Nov         | 10          | T           | State-space modeling for EBFM (Dr. Greg Britten, MIT)    |
+---------------+-------------+-------------+------------------------------------------------------------+
| 3-Nov         | 10          | Th          | Woods Hole Assessment Model (WHAM) (Dr. Tim Miller, NOAA NEFSC)\   |
...
+---------------+-------------+-------------+------------------------------------------------------------+
| 15-Nov        | 12          | T           | Marine spatial planning & Dynamic Ocean Management                                    |
+---------------+-------------+-------------+------------------------------------------------------------+
| 17-Nov        | 12          | Th          | Fleet dynamics modeling                 |
+---------------+-------------+-------------+------------------------------------------------------------+
