...
**Course Objectives**: 
1. Familiarity with a range of models used for ecosystem-based management and experience using some of them. 
2. Understanding of the benefits, challenges, and limitations of using these models to provide scientific advice for management.
