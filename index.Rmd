...
+---------------+-------------+-------------+------------------------------------------------------------+
| 20-Sep        | 4           | T           | Qualitative modeling I\         |
|               |             |             | *Project descriptions due*                                 |
+---------------+-------------+-------------+------------------------------------------------------------+
| 22-Sep        | 4           | Th          | Qualitative modeling II\     |
...
| 13-Oct        | 7           | Th          | WGSAM                                                      |
+---------------+-------------+-------------+------------------------------------------------------------+
| 18-Oct        | 8           | T           | Guest lecture, Ecosystem Indicator Analyses                               |
+---------------+-------------+-------------+------------------------------------------------------------+
...
|               |             |             | *Project plans due*                                        |
+---------------+-------------+-------------+------------------------------------------------------------+
| 1-Nov         | 10          | T           | Guest Lecture, State-space modeling for EBFM     |
+---------------+-------------+-------------+------------------------------------------------------------+
| 3-Nov         | 10          | Th          | Guest Lecture, Woods Hole Assessment Model (WHAM) Models of Intermediate Complexity for Ecosystems (MICE)\   |
|               |             |             | *Homework 4 due (Rpath tradeoff analysis)*                 |
+---------------+-------------+-------------+------------------------------------------------------------+
| 8-Nov         | 11          | T           | Guest Lecture, Climate-linked fisheries stock assessment Fleet dynamics                                             |
+---------------+-------------+-------------+------------------------------------------------------------+
| 10-Nov        | 11          | Th          | Multispecies policy analysis - fishery ecosystem plans               |
+---------------+-------------+-------------+------------------------------------------------------------+
| 15-Nov        | 12          | T           | Marine spatial planning                                    |
+---------------+-------------+-------------+------------------------------------------------------------+
| 17-Nov        | 12          | Th          | Dynamic Ocean Management                 |
+---------------+-------------+-------------+------------------------------------------------------------+
